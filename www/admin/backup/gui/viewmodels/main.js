function SmartBackup() {
	...
	this.editBackup = function (title) {
		$.getJSON('backup/api/index.php?path=/backups/get&title=' + title + '&key=' + self.password(), function (data) {
	...
	this.onLogin = function () {
		jQuery.getJSON('backup/api/index.php?path=/checkInstall&key=' + self.password(), function (data) {
...
KnockoutComponents.basePath = 'backup/gui/components/';
KnockoutComponents.defaultSuffix = '.php';
...
$(function($) {
	...
	// OLD $('#alertsContainer .alert').live('closed', function () {
	$('#alertsContainer .alert').on('closed', 'a', function () {
		Application.alerts.remove(ko.dataFor(this));
	});
